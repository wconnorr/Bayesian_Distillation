# Deep ensembles combining distillation-trained and true task-trained models
...
if __name__ == '__main__':
  ...
  model_sd = torch.load('../mnist_sl/learner_sd.pt', map_location=torch.device('cpu'))
  ensemble[0].load_state_dict(model_sd)
